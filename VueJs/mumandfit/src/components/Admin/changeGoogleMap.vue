<template>
    <div id ="changeMap">
        ...
        <div id="changeMapCorps">
            <p>1 - Rendez-vous sur <a href = "https://www.google.fr/maps">Google Map</a> et rentrez votre adresse dans le champs prévu à cet effet.</p>
            ...
            <p><strong>ATTENTION</strong>, veuillez ne conserver <strong>que</strong> la partie qui se trouve <strong>entre les guillemets</strong> et qui commence par "https://www.google.com/maps/embed?pb=[...]"</p>
